...
# i.e. +, -, *, **, /			#
#########################################
def calc_pos_pred_value(data_set):
	correctly_positive_results = count_accurate(True, data_set)
	all_positive_results = count_positives(data_set)
	return 100 * correctly_positive_results / all_positive_results

def calc_neg_pred_value(data_set):
	correctly_negative_results = count_accurate(False, data_set)
	all_negative_results = count_negatives(data_set)
	return 100 * correctly_negative_results / all_negative_results
...
positive_predictive_value = calc_pos_pred_value(diagnoses)
negative_predictive_value = calc_neg_pred_value(diagnoses)
