...
class TestRandomPosAndNegPredValue(unittest.TestCase):
    ...
    def test_PosPredValueRandom(self):
        self.assertAlmostEqual(100, calc_pos_pred_value(count_accurate(True, self.RandomDI), count_inaccurate(True, self.RandomDI), count_positives(self.RandomDI), count_tests(self.RandomDI)))

    def test_NegPredValueRandom(self):
        self.assertAlmostEqual(100, calc_pos_pred_value(count_accurate(False, self.RandomDI), count_inaccurate(False, self.RandomDI),count_negatives(self.RandomDI), count_tests(self.RandomDI)))
